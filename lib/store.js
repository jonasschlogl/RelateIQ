  ...
  getConnection()
    .prepare(
      ...
      ON CONFLICT(id) DO UPDATE SET
        ...
        therapistSummaryAt=excluded.therapistSummaryAt`
    )
    .run(r);
  return conv;
}
  ...
  getConnection()
    .prepare(
      `INSERT INTO partnerProfiles (
        ...
        learnedProfile, learnedVoice, learnedProfileConfidence, learnedProfileUpdatedAt
      ) VALUES (
        :id, :userId, :name, :traits, :context, :attachmentStyle, :createdAt,
        :learnedProfile, :learnedVoice, :learnedProfileConfidence, :learnedProfileUpdatedAt
      )
      ON CONFLICT(id) DO UPDATE SET
        ...
        learnedProfileUpdatedAt=excluded.learnedProfileUpdatedAt`
    )
    .run(r);
  return p;
}
